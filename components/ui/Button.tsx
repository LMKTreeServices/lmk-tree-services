  ...
  return (
    <button
      className={cn(
        ...
        {
          'bg-primary-600 text-white hover:bg-primary-700 focus:ring-primary-500 shadow-lg shadow-primary-600/30':
            variant === 'primary',
          'bg-bark-800 text-white hover:bg-bark-900 focus:ring-bark-500':
            variant === 'secondary',
